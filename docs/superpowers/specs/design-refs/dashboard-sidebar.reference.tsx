...
/*
REFERENCE ONLY — this file also originally included a full-page preview
(SidebarNavPreview) with a topbar (breadcrumb + collapse toggle + command-K
search modal) wrapping the sidebar in a demo shell. That command-K search
modal pattern (Search icon trigger -> centered overlay with ESC-to-close) and
the PanelLeftClose/PanelLeftOpen collapse toggle in the topbar are both
worth carrying into HomeScreen's topbar — adapt them there, not just inside
