...
\hypersetup{
  ...
  pdfauthor={Diego Jesús Gutierrez},
...
% DATOS DEL DOCUMENTO
% -----------------------------------------------------------------------
\title{Desarrollo de unEcosistema multiagente para la generación y validación de circuitos analógicos CA/CD a partir de lenguaje natural}
...
%   \input{sections/resumen}
  ...
  \input{sections/limites_alcances}
  ...
  \input{sections/propuesta_solucion}
