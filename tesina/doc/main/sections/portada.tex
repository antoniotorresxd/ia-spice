...
\begin{titlepage}
    ...
    {\LARGE \textbf{Reporte de proyecto}}\\[0.8cm]
    
    {\Large \textit{Ecosistema multiagente para la generación y validación de circuitos analógicos CA/CD a partir de lenguaje natural}}\\[1.5cm]
    ...
    \large ASESOR:\\[0.3cm]
    \textbf{M. en C. RICARDO ISRAEL CALZADA SALAS}\\[1.5cm]
