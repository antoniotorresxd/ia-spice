...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \hspace*{-0.5cm}\includegraphics[width=1.3\textwidth, keepaspectratio]{../src/diagrams/diagrama_funcional.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \hspace*{-0.5cm}\includegraphics[width=1.3\textwidth, keepaspectratio]{../src/diagrams/casos_uso_simulacion.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \hspace*{-0.5cm}\includegraphics[width=1.3\textwidth, keepaspectratio]{../src/diagrams/c4_l1_v4.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \hspace*{-0.5cm}\includegraphics[width=1.3\textwidth, keepaspectratio]{../src/diagrams/c4_l2_v4.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \hspace*{-0.5cm}\includegraphics[width=1.3\textwidth, keepaspectratio]{../src/diagrams/c4_l3_v4.png}%
    }
...
\begin{figure}[H]
    \centering
    \makebox[\textwidth][c]{%
        \hspace*{-0.5cm}\includegraphics[width=1.3\textwidth, keepaspectratio]{../src/diagrams/secuencia_flujo_principal.png}%
    }
